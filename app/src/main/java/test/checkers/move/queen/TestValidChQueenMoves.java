package test.checkers.move.queen;
...
public class TestValidChQueenMoves {
    TestBoardCreator testGameCreator = new TestBoardCreator();

    @Test
    public void testValidChQueenMoves() {
        Piece piece = CheckersPieceFactory.createQueen(Color.WHITE);
